...
# phi therefore measures nothing, and an earlier version of this section reported "never
# negative down to 1e-8" from one fixed draw that happened to survive.  The sweep is over an
# ensemble, and reports the *rate* at which definiteness is lost alongside the accuracy loss,
